...
class _CartPageState extends State<CartPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<Item> listaProduto =
        provider.items == null ? [] : provider.items;
    return Scaffold(
      appBar: AppBar(
        elevation: 0,
        title: Text('Carrinho'),
          ...
          InkWell(
            onTap: (){
              if(listaProduto.length != 0){
                ...
                exibirSnackbar(context,'Sacola Vazia, que tal adicionar alguns produtos!', Colors.redAccent );
              }
            ...
            child: Container(
              ...
              child: Text('Pagamento', style: TextStyle(fontSize: 25, color: PaletaDeCores.backgroundColorSecundary),),
            ),
          )
        ],
      ),
